...
export function processDetailedData(timeData: TimeData, period: Period): Record<string, number> {
    const now = new Date();
...
export function populateDetailedTable(tbody: HTMLTableSectionElement, data: Record<string, number>): void {
    tbody.innerHTML = "";
